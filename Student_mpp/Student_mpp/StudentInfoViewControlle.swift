//
//  StudentInfoViewControlle.swift
//  Student_mpp
//
...
class StudentInfoViewControlle: UIViewController {

    
    @IBOutlet weak var SOutlet: UILabel!
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            if transition == "courseSegue" {
                let destination = segue.destination as! coursedetailviewControlle
